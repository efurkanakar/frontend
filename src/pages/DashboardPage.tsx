/** @file Dashboard route presenting KPIs and visual trends. */
  ...
  const cards = useMemo(() => {
    ...
    return [
      ...
      },
      {
        ...
        value: typeof shortestOrbit === 'number' ? `${decimalFormatter.format(shortestOrbit)} days` : '—',
        hint: 'Fastest orbit measured among confirmed planets',
        loading: statsQuery.isLoading,
      },
      {
        title: 'Hottest host star',
        value: typeof hottestStar === 'number' ? `${numberFormatter.format(hottestStar)} K` : '—',
        hint: 'Peak stellar effective temperature in the catalogue',
        loading: statsQuery.isLoading,
      },
    ]
  }, [

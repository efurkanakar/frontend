...
export interface PlanetListParams extends Record<string, unknown> {
  limit?: number
  offset?: number
  name?: string
  disc_method?: string
...
export interface PlanetTimelineParams extends Record<string, unknown> {
  start_year?: number
  end_year?: number
  include_deleted?: boolean
}
...
export interface DiscoveryQueryParams extends Record<string, unknown> {
